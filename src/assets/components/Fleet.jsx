      ...
      <section className="py-24 bg-slate-50" id="fleet">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <span className="text-gold-600 font-bold tracking-[0.2em] uppercase text-xs bg-gold-100 px-4 py-2 rounded-full">
              Navara Collection
            </span>
            <h2 className="text-4xl md:text-6xl font-serif font-black text-navy-900 mt-6 mb-6 tracking-tight">
              Armada <span className="text-gold-600">Pilihan</span>
            </h2>
            <p className="text-slate-600 text-lg leading-relaxed">
              Kombinasi sempurna antara kenyamanan Big Bus dan fleksibilitas
              Hiace untuk segala kebutuhan perjalanan Anda.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
            ...
            <div className="md:col-span-2 md:row-span-2 relative rounded-[2.5rem] overflow-hidden group shadow-2xl ring-1 ring-black/5">
              ...
              <div className="absolute bottom-0 left-0 p-10 w-full">
                ...
                <h3 className="text-4xl font-serif font-black text-white mb-2">
                  Full Entertainment
                </h3>
                <p className="text-slate-300 max-w-md">
                  Nikmati perjalanan dengan fasilitas Karaoke, TV LED, dan Sound
                  System premium di setiap armada kami.
                </p>
              </div>
            </div>
            ...
            <div className="relative rounded-[2rem] overflow-hidden group shadow-xl ring-1 ring-black/5">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                ...
                <p className="text-white/80 text-sm mt-2">
                  Ergonomic Seats & Spacious Legroom
                </p>
              </div>
            </div>
            ...
            <div
              ...
              className="relative rounded-[2rem] overflow-hidden group shadow-xl bg-gradient-to-br from-gold-600 to-gold-700 flex flex-col items-center justify-center text-center p-8 cursor-pointer hover:from-gold-500 hover:to-gold-600 transition-all"
            >
              ...
              <p className="text-white/80 text-sm mb-6">
                Amankan unit pilihan Anda untuk liburan mendatang.
              </p>
              <button className="bg-white text-gold-700 px-6 py-2 rounded-full font-bold text-sm hover:bg-gold-50 transition-colors">
                Hubungi Kami
              </button>
            </div>
          </div>
...
const FleetCard = ({ item, activeCard, setActiveCard, onClick }) => (
  ...
  >
    <img
      ...
      alt={item.title}
    />
    <div className="absolute inset-0 bg-gradient-to-t from-navy-900 via-navy-900/20 to-transparent opacity-90 group-hover:opacity-100 transition-opacity"></div>
    ...
    <div className="absolute bottom-0 left-0 p-8 w-full">
      ...
      <p className="text-gold-400 font-medium text-sm mb-4">{item.capacity}</p>

      <div className="flex flex-wrap gap-2 mb-6">
        {item.tags.map((tag) => (
          <span
            key={tag}
            className="text-[10px] bg-white/10 text-slate-200 px-2.5 py-1 rounded-lg border border-white/10"
          >
            {tag}
          </span>
        ))}
      ...
      <div
        className={`flex items-center gap-2 text-white font-bold text-sm transition-all duration-300 ${
          activeCard === item.id
