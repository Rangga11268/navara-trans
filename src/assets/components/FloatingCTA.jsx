  ...
  return (
    <div className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-50 transition-all duration-500 ${showFloatingCTA ? 'translate-y-0 opacity-100' : 'translate-y-24 opacity-0'}`}>
       <a
         ...
         className="bg-green-600 text-white px-6 py-3 rounded-full shadow-2xl font-bold flex items-center gap-3 hover:bg-green-700 transition-colors ring-4 ring-white/20 backdrop-blur-sm animate-pulse"
       >
